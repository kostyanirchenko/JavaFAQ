...
public class Database {
    ...
    public static final String url = "jdbc:mysql://localhost:3306/javafaq";
    ...
    public static void setConnection() {
        String url = "jdbc:mysql://localhost:3306/javafaq";
        String login = "root";
    ...
    public static void setResultSet(String query) throws SQLException {
        if(!query.isEmpty()) {
            ...
            throw new NullPointerException("Не указана строка запроса");
        }
    }
